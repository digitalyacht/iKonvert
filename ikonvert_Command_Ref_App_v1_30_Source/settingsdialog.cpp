    ...
    m_intValidator(new QIntValidator(0, 4000000, this))
{
    ...
    connect(m_settings_ui->Load_button, &QPushButton::clicked, this, &SettingsDialog::call_table_query);
    connect(m_settings_ui->Save_button, &QPushButton::clicked, this, &SettingsDialog::call_send_rx_list);
    connect(m_settings_ui->Reset_button, &QPushButton::clicked, this, &SettingsDialog::call_reset);
...
void SettingsDialog::fillPortsInfo()
{
    ...
    //m_settings_ui->serialPortInfoListBox->addItem(tr("NavLink2(UDP)"));
    m_settings_ui->serialPortInfoListBox->addItem(tr("NavLink2(TCP)"));
...
void SettingsDialog::readReply(QByteArray rx_str, QByteArray tx_str)
{
    ...
    foreach ( const QByteArray &rx_pgn, rx_pgns)
    {
        ...
        if(rx_pgn == "130306") m_settings_ui->rx128RB->setChecked(true);
    ...
    foreach ( const QByteArray &tx_pgn, tx_pgns)
    {
        ...
        if(tx_pgn == "130311") m_settings_ui->tx130RB->setChecked(true);
